        ...
        <div className={styles.blogEditor}>
          {isLoading && !draft ? <p className={styles.loading}>Cargando entradas...</p> : draft ? (
            <>
              ...
              {!isNew && draft.status === "draft" && <button className={styles.publishButton} type="button" disabled={hasChanges || isSaving} onClick={() => setConfirmPublish(true)}>Publicar</button>}
